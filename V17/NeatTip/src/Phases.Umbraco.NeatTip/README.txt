...
* TypeScript services observe `umb-property-layout` elements in the document workspace
* Lit web component `neat-tip-indicator` renders the info icon
* Descriptions are rendered via `umb-ufm-render` in a global draggable tooltip
