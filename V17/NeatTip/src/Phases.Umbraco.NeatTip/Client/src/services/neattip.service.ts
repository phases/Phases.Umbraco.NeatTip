...
export class NeatTipService {
  ...
  constructor(host: UmbControllerHost) {
    ...
    this.#tooltipManager = new TooltipManagerService(this.#permissions);
    this.#processor = new PropertyProcessorService(this.#workspace, this.#tooltipManager);
    this.#scanner = new PropertyScannerService(this.#workspace, this.#processor);
  }
